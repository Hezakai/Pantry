-- This file file is used to manage the database schema of a project during the db setup and init process.  NOTE:  Executing this file will result in the loss of ALL data stored in the pantry_db database.
